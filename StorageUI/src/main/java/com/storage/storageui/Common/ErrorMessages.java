...
public class ErrorMessages {
    ...
    //Create agent
    public static final String FirstName = "First name should start with upper case and have at least 2 characters!";
    public static final String LastName = "Last name should start with upper case and have at least 2 characters!";
    ...
    //Change password
    public static final String PasswordChange = "Passwords doesn't match!";

    //Create storage
    public static final String Width = "Width should be a number!";
